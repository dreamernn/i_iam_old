...
class HotelajaxController extends \BaseController {
    ...
    public function updateHotelAction() {
        ...
        $paramList['logo'] = $this->getFile('logo');
        $paramList['pdf'] = $this->getFile('pdf');
        $paramList['index_background'] = $this->getFile('indexBackground');
        $paramList['localpic'] = $this->getFile('localpic');
        $paramList['voice_lang1'] = $this->getFile('voiceLang1');
        ...
        $paramList['invoice_id'] = trim($this->getPost('invoiceId'));
